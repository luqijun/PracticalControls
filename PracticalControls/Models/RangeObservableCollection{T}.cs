...
namespace PracticalControls.Models
{
    ...
    public class WpfRangeObservableCollection<T> : RangeObservableCollection<T>
    {
        DeferredEventsCollection _deferredEvents;

        public WpfRangeObservableCollection()
        {
        }

        public WpfRangeObservableCollection(IEnumerable<T> collection) : base(collection)
        {
        }

        public WpfRangeObservableCollection(List<T> list) : base(list)
        {
        }
        ...
        protected override void OnCollectionChanged(NotifyCollectionChangedEventArgs e)
        {
            ...
            foreach (var handler in GetHandlers())
                ...
                {
                    var d= cv.DeferRefresh();// cv.Refresh();
                    d.Dispose();
                }
                else
                    handler(this, e);
        ...
        {
            private readonly WpfRangeObservableCollection<T> _collection;
            public DeferredEventsCollection(WpfRangeObservableCollection<T> collection)
            {
